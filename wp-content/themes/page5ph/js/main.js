...
$(document).ready(function(){
  ...
  if ($.find('.twitter-share')[0]) {
    var twitterShare = document.querySelector('[data-js="twitter-share"]');
    twitterShare.onclick = function(e) {
      var twitterText = $('.cat-single-container h1').text();
      e.preventDefault();
      var twitterWindow = window.open('https://twitter.com/intent/tweet?url=' + document.URL + '&via=Page5_ph&text=' + twitterText, 'twitter-popup', 'height=350,width=600');
      if(twitterWindow.focus) { twitterWindow.focus(); }
      return false;
    }
  }

  if ($.find('.facebook-share')[0]) {
