<?php
  ...
  $columnLayout = $pageBanner['column_layout'];
  switch ($columnLayout) {
    case 'column1':
      $columnClass = 'col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-0 col-md-10 col-lg-9';
      break;
    
    default:
      $columnClass = 'col-xs-10 col-xs-offset-1 col-sm-7 col-sm-offset-0';
      break;
  }
?>
